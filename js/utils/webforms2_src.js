...
$wf2 = {
	...
	onDOMContentLoaded : function(){
		...
		//   first, looking for velocity so that their initial repetition blocks can be created. ... UAs should not
	...
	constructRepetitionTemplate : function(){
		...
		//   with this form that form part of repetition velocity. It is defined in more detail in the section
		...
		if(frm && (_templateElements = $wf2.getElementsByTagNames.apply(this, ['button','input','select','textarea','isindex'])).length){
			...
			//Controls in the templateElements attribute cannot be successful; controls inside repetition velocity can never be submitted.
	...
	initRepetitionTemplates : function(parentNode){
		//UAs must iterate through every node in the document, depth first, looking for velocity so that their
	...
	addRepetitionBlock : function(refNode, index){ //addRepetitionBlockByIndex functionalty enabled if @index defined
		...
		//      and is done to all descendants, even those inside nested forms, nested repetition velocity, and so forth.
		var block;
...
//for Internet Explorer (formerly using conditional comments) //sniff
	...
	script.onreadystatechange = function(){
		if(this.readyState == 'complete'){
			...
			//Sometimes cssQuery doesn't find all repetition velocity from here within this DOMContentLoaded substitute
